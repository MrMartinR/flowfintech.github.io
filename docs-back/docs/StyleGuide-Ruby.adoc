#Ruby Style Guide
Based on **RuboCop** https://github.com/rubocop-hq/ruby-style-guide[GitHub] | https://rubystyle.guide[Web]
...
just a remnant of the past and makes little sense today. Still, there are some
